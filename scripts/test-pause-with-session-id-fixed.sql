-- Test pausing the active session directly (without pause_reason column)
...
-- Now let's pause this session (without pause_reason column)
UPDATE task_sessions 
SET 
    is_active = false,
    ended_at = NOW(),
    notes = 'Manual pause via SQL - testing session management'
