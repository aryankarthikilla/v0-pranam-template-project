...
export async function updateSubject(
  ...
  revalidatePath("/dashboard/presentations");
  revalidatePath(`/dashboard/presentations/${id}`);
  return subject;
}
...
export async function createSlide(data: Partial<Slide>): Promise<Slide> {
  ...
  revalidatePath(`/dashboard/presentations/${data.subject_id}`);
  return slide;
}
...
export async function updateSlide(
  ...
  revalidatePath(`/dashboard/presentations/${slide.subject_id}`);
  return slide;
}
...
export async function duplicateSlide(id: string): Promise<Slide> {
  ...
  revalidatePath(`/dashboard/presentations/${originalSlide.subject_id}`);
  return newSlide;
}
...
export async function reorderSlides(
  ...
  revalidatePath(`/dashboard/presentations/${subjectId}`);
}
