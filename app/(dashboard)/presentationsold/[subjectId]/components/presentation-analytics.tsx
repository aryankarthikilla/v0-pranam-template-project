...
const mockAnalytics = {
  ...
  sessionHistory: [
    { date: "2024-01-15", audience: 25, rating: 4.8, duration: 60 },
    { date: "2024-01-10", audience: 30, rating: 4.5, duration: 65 },
    { date: "2024-01-05", audience: 28, rating: 4.7, duration: 58 },
    { date: "2024-12-20", audience: 35, rating: 4.4, duration: 70 },
    { date: "2024-12-15", audience: 22, rating: 4.9, duration: 55 },
  ],
  feedback: [
...
export function PresentationAnalytics({ subject, slides, onClose }: Props) {
  ...
  const exportAnalytics = () => {
    ...
    a.href = url;
    a.download = `${subject.name}-analytics-${
